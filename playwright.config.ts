...
// what the suite drives — including a stale preview of another vite project,
// which all of them ship on the same 4173. Override rather than edit this file
// when that happens:
//
...
export default defineConfig({
  ...
  // once the suite has enough tests for it to matter.
  workers: 1,
  fullyParallel: false,
  ...
  use: {
    baseURL: BASE_URL,
    // The app's shell is phone-first (a bottom nav); this is the viewport it is
    // designed for. Not `isMobile`, which changes little here beyond making
    // clicks flakier.
